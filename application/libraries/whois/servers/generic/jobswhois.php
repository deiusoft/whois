...
class JobsWhois extends \Whois\Server
{
	protected $host = 'jobswhois.verisign-grs.com';
	protected $surplus = array('0', '1', 'last', '4');
	protected $allow = array('jobs');
	...
	{
		if (preg_match('/whois.nameshare.com/', $this->body))
			return 'whois-jobs.nameshare.com';
